...
import { SiJava, SiSpringboot, SiMysql, SiReact, SiRedux, SiBootstrap, SiNextdotjs, SiTailwindcss, SiNodedotjs } from "react-icons/si";
import { RiGithubLine, RiFacebookCircleLine, RiLinkedinBoxLine, RiTelegramLine } from "react-icons/ri";
...
export const greeting = [
	...
	() => (
		<>
			<CustomLink name="Hong Sovichet." />
		</>
	),
	() => (
		<>
			I&apos;m a hard-working and quick learner student at the <CustomLink href="http://www.rupp.edu.kh" name="Royal University of Phnom Penh" />.
			Currently,&nbsp;I&apos;m&nbsp;working&nbsp;as&nbsp;
			<CustomLink name="API Developer" />, and I am also interested in &nbsp;
			<CustomLink name="Frontend development" /> and <CustomLink name="Backend development" />.
		</>
	),
];
...
export const socialMedia = [
	{
		...
		href: "https://github.com/SovichetHong",
	},
	{
		icon: <RiFacebookCircleLine size="1.5rem" />,
		href: "https://www.facebook.com/SovichetHong",
	},
	{
...
export const favoriteTechStacks = {
	java: [
		() => (
			<p>
				<CustomLink href="https://www.java.com/en" name="Java" />, I started using java for development, which is great for building function and has a lot of open sources library that
				we need to use in spring boot framework.
			</p>
		),
	...
	spring: [
		() => (
			<p>
				<CustomLink href="https://spring.io" name="Spring Boot" />, I started using spring boots because it great for developing an API for any project.
			</p>
		),
